...
HD_PWD='E:/ps_pl_bram/ps_pl_bram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systembram_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systembram_wrapper.tcl
