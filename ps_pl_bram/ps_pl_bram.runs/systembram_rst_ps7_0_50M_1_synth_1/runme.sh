...
HD_PWD='E:/ps_pl_bram/ps_pl_bram.runs/systembram_rst_ps7_0_50M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systembram_rst_ps7_0_50M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systembram_rst_ps7_0_50M_1.tcl
