...
HD_PWD='E:/ps_pl_bram/ps_pl_bram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log systembram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source systembram_wrapper.tcl -notrace
