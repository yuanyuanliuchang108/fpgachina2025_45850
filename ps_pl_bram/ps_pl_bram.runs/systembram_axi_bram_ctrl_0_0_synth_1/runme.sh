...
HD_PWD='E:/ps_pl_bram/ps_pl_bram.runs/systembram_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systembram_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systembram_axi_bram_ctrl_0_0.tcl
